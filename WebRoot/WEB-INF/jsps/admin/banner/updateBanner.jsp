		...
		<div class="container-fluid">
			<div class="widget-box">
				<div class="widget-title">
					<span class="icon"> <i class="icon-move"></i>
					</span>
					<h5>修改图片</h5>
				</div>
				<div class="widget-content nopadding">
					<form
						action="<%=request.getContextPath()%>/admin/banner_modBanner.Q"
						...
						<div class="control-group">
							...
							<div class="controls">
								<input class="span11" name="banner.imglink" value="${banner.imglink}" />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">效果图 :</label>
							<div class="controls">
								<img alt="" src="${readpath}${banner.imgpath}" width="200" height="200">
							</div>
							</div>
