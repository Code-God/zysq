...
<html lang="en">
	...
	function initData(page) {
		...
		$.ajax({
			type : "POST",
			url : CONFIG.context + "/admin/car_loadRescueList.Q",
	...
	function delRecord(id){
		art.dialog({
		    ...
		    ok: function () {
		    	 $.ajax({
					type : "POST",
					url : CONFIG.context + "/admin/car_delRescue.Q",
					data : "dbId=" + id,
					dataType : "json",
					success : function(data) {
						if(data.msg == "ok"){
	...
	function addRescue(){
		...
		$.ajax({
			type : "POST",
			url : CONFIG.context + "/admin/car_addRescue.Q",
			data : param,
			dataType : "json",
			success : function(data) {
				if(data.msg == "ok"){
					         ...
					         <form class="form-horizontal" method="get" action="#">
					           <div class="control-group">
					              ...
					              <div class="controls">
					                <select  id="facName" style="width: 250px">
				                		...
				                		<s:iterator var="ss" value="#request.serviceList">
				                			<option value='<s:property value="company"/>'><s:property value="company"/> </option>
				                		</s:iterator>
				                	</select>
					            ...
					            <div class="form-actions">
									...
									<button onclick="$('#rescueInfoDiv').hide()" class="btn btn-inverse">取消</button>
					            </div>
					            </form>
					        </div>
					      </div>
