...
<SCRIPT language=javascript>
		...
		function addItem(){
			window.location.href="<%=request.getContextPath()%>	/admin/drugDisease_inputDiseaseItem.Q";
		}
		function delItem(){
			...
			if(selectCheckbox.length<1){
				...
				art.dialog({
				    ...
				    ok: function () {
				    	$.ajax({
							url:"<%=request.getContextPath()%>/admin/drugDisease_delDiseaseItem.Q",
		...
		function updateDisease(id){			
 			var url = "<%=request.getContextPath()%>/admin/drugDisease_inputDiseaseItem.Q";
 			if(id){
 				url+="?id="+id;
 			}
			...
			<div class="widget-box">
				<div class="widget-box">
					<div class="widget-content">
						<form action="<%=request.getContextPath()%>/admin/drugDisease_diseaseCenterCountManager.Q"
...
<!-- 	        	 	</s:if>							 -->
						 ...
						 <div class="widget-content nopadding" id="diseaseTableId">
	          					  <%@include file="drugDiseaseCenterCountList.jsp"%>
	     				 </div>
					</div>
				</div>
			</div>
