...
function getUsersList(id){
		var url = "<%=request.getContextPath()%>/admin/drugUDRelation_usersManager.Q";
		if(id){
			url+="?referrerId="+id;
		}
			...
			<div class="widget-box">
				<div class="widget-box">
					<div class="widget-content">
						<form action="<%=request.getContextPath()%>/admin/drugUDRelation_recommendedManager.Q"
							method="post" id="recommendedQueryForm">
					...
					<div class="widget-title">
						...
						<h5>推荐人列表</h5>										
						 ...
						 <div class="widget-content nopadding" id="recommendedTableId">
	          					  <%@include file="drugRecommendedList.jsp"%>
	     				 </div>
					</div>
				</div>
			</div>
