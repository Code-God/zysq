...
public class AddressDao extends EnhancedHibernateDaoSupport<Address> {
	...
	public Page<Address> findForPage(Page<Address> page, Map<String,Object> paramap){
		...
		try {
			...
			List<Address> list = this.findList4PageWithParama(hql.toString(), page
	 ...
	 * @return
	 */
	public Page<Address> findPage(Page<Address> page, Map<String,Object> paramap){
		...
		page.setTotalCount(totalCount);
		List<Address> list = this.findList4Page(hql.toString(), page.getFirst() - 1, page.getPageSize());
		page.setData(list);
		return page;
	}
}