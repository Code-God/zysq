...
public class AlipaySubmit {
    ...
    private static String sign_type = Version.getInstance().getNewProperty("alipay.sign_type");
    private static String key = Version.getInstance().getNewProperty("alipay.key");
    private static String input_charset = Version.getInstance().getNewProperty("alipay.input_charset");
    private static String partner = Version.getInstance().getNewProperty("alipay.partner");
    /** 
     * 生成签名结果
     * @param sPara 要签名的数组
     * @return 签名结果字符串
