...
@Repository("wxRuleImageDao")
public class WxRuleImageDao extends EnhancedHibernateDaoSupport<WxRulesImage> {

	@Override
	protected String getEntityName() {
		return WxRulesImage.class.getName();
	}
	...
	public Map<String, Object> queryRecord(int start, int limit, Map<String, String> paramMap) {
		...
		List<WxRulesImage> list = new ArrayList<WxRulesImage>();
		
		String hql = "from WxRulesImage where 1=1 ";
