...
//            gs.drawImage(img, width_4 + width_8, height_4 + height_8,width_4,height_4, null);  
	 ...
	 * @return
	 */
	public  int createQRCode(String content, String imgPath,String logo) {  
	       ...
	       try {  
	           ...
	           /** * 设置logo的大小,本人设置为二维码图片的20%,因为过大会盖掉二维码 */
	            int widthLogo = img.getWidth(null)>bufImg.getWidth()*3/10?(bufImg.getWidth()*3/10):img.getWidth(null), 
	                heightLogo = img.getHeight(null)>bufImg.getHeight()*3/10?(bufImg.getHeight()*3/10):img.getWidth(null);
	           ...
	           //开始绘制图片
	             System.out.println(widthLogo+""+heightLogo+"pppppppppppppppppppppppppppppppppppp");
	             gs.drawImage(img, x, y, widthLogo, heightLogo, null);
	          // gs.drawImage(img, 53, 53, 36, 36, null);
	...
	public static void main(String[] args) {
		String imgPath = "E:/360Downloads/Michael_QRCode.png";
		String encoderContent = "Hello 大大、小小,welcome to QRCode!"
				+ "\nMyblog [ http://sjsky.iteye.com ]Hello 大大、小小,welcome to QRCode!"
